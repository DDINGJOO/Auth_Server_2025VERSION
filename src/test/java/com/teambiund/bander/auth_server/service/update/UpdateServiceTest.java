...
class UpdateServiceTest {
  ...
  class UpdateEmailTests {
    ...
    void updateEmail_validInput_success() {
      ...
      Auth auth = Auth.builder().id(userId).email("old@example.com").status(Status.ACTIVE).build();
  ...
  class ChangePasswordTests {
    ...
    void changePassword_backwardCompatibility_success() {
      ...
      Auth auth =
          Auth.builder().id("user-id-123").email(email).password("oldHashedPassword").build();
    ...
    void changePassword_passwordIsHashed() {
      ...
      Auth auth =
          Auth.builder().id("user-id-123").email(encryptedEmail).password("oldPassword").build();
