...
class SignupServiceImplTest {
  ...
  @Mock private SignupStoreService signupStoreService;

  @Mock private ConsentManagementService consentService;

  @Mock private CreateProfileRequestEventPub publishEvent;

  @Mock private EmailConfirm emailConfirm;
  ...
  class SignupTests {
    ...
    void signup_validInput_success() {
      ...
      List<ConsentRequest> consentReqs =
          List.of(ConsentRequest.builder().consentId("test-consent-id-1").consented(true).build());
    ...
    void signup_publishEventWithCorrectData() {
      ...
      Auth expectedAuth = Auth.builder().id("user-id-123").provider(Provider.SYSTEM).build();
      SignupRequest req =
          SignupRequest.builder()
              .email(email)
              .password(password)
      ...
      ArgumentCaptor<CreatedUserEvent> eventCaptor =
          ArgumentCaptor.forClass(CreatedUserEvent.class);
    ...
    void signup_emailNotConfirmed_throwsException() {
      ...
      SignupRequest req =
          SignupRequest.builder()
              ...
              .build();
      // when & then
      assertThatThrownBy(() -> signupService.signup(req)).isInstanceOf(CustomException.class);
  ...
  class SignupFromOtherProviderTests {
    ...
    void signupFromOtherProvider_kakao_success() {
      ...
      Auth expectedAuth =
          Auth.builder().id("kakao-user-123").email(email).provider(Provider.KAKAO).build();
    ...
    void signupFromOtherProvider_apple_success() {
      ...
      Auth expectedAuth =
          Auth.builder().id("apple-user-123").email(email).provider(Provider.APPLE).build();
    ...
    void signupFromOtherProvider_publishEventWithCorrectProvider() {
      ...
      Auth expectedAuth = Auth.builder().id("social-user-123").provider(Provider.KAKAO).build();
  ...
  class IntegrationScenarioTests {
    ...
    void scenario_fullSignupFlow() {
      ...
      Auth expectedAuth =
          Auth.builder().id("integration-user-123").email(email).provider(Provider.SYSTEM).build();
      SignupRequest req =
          SignupRequest.builder()
              .email(email)
              .password(password)
    ...
    void scenario_fullSocialSignupFlow() {
      ...
      Auth expectedAuth =
          Auth.builder().id("social-integration-123").email(email).provider(Provider.KAKAO).build();
  ...
  class ExceptionTests {
    ...
    void signup_nullParameters_throwsException() {
      ...
      SignupRequest req =
          SignupRequest.builder()
              ...
              .build();
      // when & then - null 이메일
      assertThatThrownBy(() -> signupService.signup(req)).isInstanceOf(Exception.class);
    ...
    void signup_eventPublishFails_throwsException() {
      ...
      doThrow(new RuntimeException("Event publish failed"))
          .when(publishEvent)
          .createProfileRequestPub(any(CreatedUserEvent.class));
    ...
    void signup_consentSaveFails_throwsException() {
      ...
      // when & then
      assertThatThrownBy(() -> signupService.signup(request)).isInstanceOf(CustomException.class);
    }
  }
}
