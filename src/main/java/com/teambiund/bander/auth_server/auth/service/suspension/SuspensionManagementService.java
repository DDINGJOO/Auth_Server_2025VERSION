package com.teambiund.bander.auth_server.auth.service.suspension;

import com.teambiund.bander.auth_server.auth.exception.CustomException;

/** 사용자 정지 관리 서비스 인터페이스 - 사용자 정지 해제 - 사용자 정지 처리 */
public interface SuspensionManagementService {
   ...
   */
  void suspend(String userId, String suspendReason, String suspenderUserId, Long suspendDate)
