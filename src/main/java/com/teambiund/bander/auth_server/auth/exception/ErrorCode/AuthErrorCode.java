package com.teambiund.bander.auth_server.auth.exception.ErrorCode;

import com.teambiund.bander.auth_server.auth.exception.ErrorCodeType;
...
public enum AuthErrorCode implements ErrorCodeType {
  ...
  AuthErrorCode(String errCode, String message, HttpStatus status) {
