package com.teambiund.bander.auth_server.auth.entity.consentsname;
...
public class ConsentsTable {
  ...
  /**
   * 주어진 두 버전 문자열을 비교하여 v1이 v2보다 최신인지 판단한다. - "v" 또는 "V" 접두사는 무시한다. - "v1.2" 형태를 "1.2"로 바꿔 각 숫자 파트를
   * 비교한다. - 숫자로 파싱할 수 없는 파트는 0으로 간주한다.
   *
