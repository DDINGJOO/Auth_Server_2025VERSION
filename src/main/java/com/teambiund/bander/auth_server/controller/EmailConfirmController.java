...
public class EmailConfirmController {
  ...
  @Operation(
      summary = "이메일 인증 확인",
      description = "인증 코드를 사용하여 이메일 인증을 완료합니다. " +
          "인증 완료 시 사용자 상태가 GUEST에서 USER로 변경됩니다."
  )
  @ApiResponses(value = {
      @ApiResponse(
          responseCode = "200",
  ...
  public boolean confirmEmail(
      @Parameter(description = "인증 코드", required = true, example = "123456")
  ...
  @Operation(
      summary = "인증 코드 발급",
      description = "이메일 인증을 위한 인증 코드를 생성하고 이메일로 발송합니다."
  )
  @ApiResponses(value = {
      @ApiResponse(
          responseCode = "200",
